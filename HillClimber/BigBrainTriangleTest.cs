...
//{
//    class BigBrainTriangleTest : Grapher
//    {
...
//        public BigBrainTriangleTest(double[] initialWeightValues, double initialBiasValue,
...
//        public BigBrainTriangleTest(int amountOfInputs, Random random, double mutationAmount,
...
//        public double GetError(double[][] inputs, double[] errors)
//        {            
//            double error = 0;
//            nums = Compute(inputs);
